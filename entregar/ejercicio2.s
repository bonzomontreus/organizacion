...
// 		RANA
	...
	add x8,x8,x5
	add x8,x8,96
	mov x0,x8		//  X0 contiene la direccion donde se comenzara a dibujar la primera rana
...
//----------------------------------------------------------------------------
//		PRIMER CUADRADO  (linea 357) INICIO DEL AUTO
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
	mov x20,0
	mov x25,159				// ESTE REGISTRO HACE QUE EL AUTO FRENE
	mov x0,x4
	mov x5,83
	mov x6,1024
	mul x5,x5,x6
